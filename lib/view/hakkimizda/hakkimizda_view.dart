...
class HakkimizdaView extends ConsumerStatefulWidget {
  const HakkimizdaView({super.key});
  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _HakkimizdaViewState();
}

class _HakkimizdaViewState extends ConsumerState<HakkimizdaView> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: LandingPage(
        innerWidget: Column(
          children: StaticData.hakkimizdaMetinleri.entries
              .map(
                (entry) => Container(
